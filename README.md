...
| `hwui-renderer` | Optional | N/A | UI Renderer. Possible value is `skiagl` from API>=27 https://developer.android.com/studio/run/emulator-acceleration?hl=en#skia-emulator |
